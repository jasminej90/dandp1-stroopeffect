...
In-congruency does not have an effect on the reaction time taken to name the ink color. <br />
...
In-congruency results in a significantly different reaction time taken to name the ink color. <br />
